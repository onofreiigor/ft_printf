...
# include <stdarg.h>
# include <limits.h>
# define COUNTER(num, base, res) while ((num /= base) && res++)
# define ABS(num) num = (((num) > 0) ? (num) : -(num))
# define BIT7 127
# define BIT11 2047
# define BIT16 65535
...
void				ft_lstlast(t_list **alst, void *content,
						size_t size_content);
int					ft_lstlen(t_list *alst);
void				ft_lstnadd(t_list **alst, void *content,
						size_t size_conten, int pos);
#endif
